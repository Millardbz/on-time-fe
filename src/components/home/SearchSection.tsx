...
export const SearchSection: FC = () => {
  return (
    <section>
      <div className="container flex flex-col bg-white px-6 py-10 h-fit lg:flex-row lg:items-center">
        <div className="w-full lg:w-1/2">
          ...
          <div className="w-full mt-8 bg-transparent border rounded-md lg:max-w-sm focus-within:border-blue-400 focus-within:ring focus-within:ring-blue-300 border-blue-400 focus-within:ring-opacity-40">
            <form className="flex flex-col lg:flex-row">
              ...
              <button
                type="button"
                className="h-10 px-4 py-2 m-1 text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 hidden lg:block"
              >
                Søg
              </button>
            </form>
          ...
          <button
            type="button"
            className="w-full lg:max-w-sm h-10 px-4 py-2 m-1 text-white transition-colors duration-300 transform bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400 lg:hidden"
          >
            Søg
          </button>
        </div>
